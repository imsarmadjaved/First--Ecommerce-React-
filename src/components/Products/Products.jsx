      ...
      <div className="container">
        <div className="text-center mb-10 max-w-[600px] mx-auto">
          ...
          <p data-aos="fade-up" className="text-xs text-gray-400">
            ...
            odit numquam dolores? Quae deleniti velit omnis fugiat fugit.
            Dolorum velit, dolorem accusamus esse voluptates hic nulla rem
            facere quam.
          </p>
        </div>
        <div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="dark:text-yellow-500">{data.rating}</span>
                  </div>
                </div>
              </div>
            ))}
